# Gemini Context for `rust-cowboyz`

This document provides context for the Gemini AI assistant to understand and effectively contribute to the `rust-cowboyz` project.
...
*   **Core Features:** Turn-based travel between planets with realistic orbital mechanics, a dynamic economy with fluctuating prices, and a cargo/inventory system. Game data is configured via YAML files.

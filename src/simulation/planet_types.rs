...
impl PlanetType {
    ...
    pub fn description(&self) -> &'static str {
        match self {
            PlanetType::Agricultural => "Agricultural Planet - Supplies Water, Foodstuffs; Demands Medicine, Firearms, Ammunition, Electronics",
            PlanetType::MegaCity => "Mega City Planet - Supplies Electronics, Medicine, Narcotics; Demands Water, Foodstuffs, Firearms, Ammunition",
            PlanetType::Mining => "Mining Planet - Supplies Metals, Antimatter, Electronics; Demands Water, Foodstuffs, Medicine, Ammunition",
            PlanetType::PirateSpaceStation => "Pirate Space Station - Supplies Narcotics, Ammunition; Demands Foodstuffs, Firearms, Medicine",
            PlanetType::ResearchOutpost => "Research Outpost - Supplies Electronics, Medicine, Alien Artefacts; Demands Water, Foodstuffs",
            PlanetType::Industrial => "Industrial Planet - Supplies Electronics, Metals, Ammunition, Antimatter; Demands Water, Foodstuffs, Medicine",
            PlanetType::FrontierColony => "Frontier Colony - Supplies Water, Foodstuffs; Demands Medicine, Firearms, Ammunition, Electronics, Metals, Antimatter, Alien Artefacts",
        }
    }
    ...
    pub fn supplies(&self) -> Vec<CommodityType> {
        match self {
            ...
            PlanetType::MegaCity => vec![CommodityType::Electronics, CommodityType::Medicine, CommodityType::Narcotics],
            PlanetType::Mining => vec![CommodityType::Metals, CommodityType::Antimatter, CommodityType::Electronics],
            PlanetType::PirateSpaceStation => vec![CommodityType::Narcotics, CommodityType::Ammunition],
            PlanetType::ResearchOutpost => vec![CommodityType::Electronics, CommodityType::Medicine, CommodityType::AlienArtefacts],
            PlanetType::Industrial => vec![CommodityType::Electronics, CommodityType::Metals, CommodityType::Ammunition, CommodityType::Antimatter],
    ...
    pub fn demands(&self) -> Vec<CommodityType> {
        match self {
            PlanetType::Agricultural => vec![CommodityType::Medicine, CommodityType::Firearms, CommodityType::Ammunition, CommodityType::Electronics],
            PlanetType::MegaCity => vec![CommodityType::Water, CommodityType::Foodstuffs, CommodityType::Firearms, CommodityType::Ammunition],
            PlanetType::Mining => vec![CommodityType::Water, CommodityType::Foodstuffs, CommodityType::Medicine, CommodityType::Ammunition],
            PlanetType::PirateSpaceStation => vec![CommodityType::Foodstuffs, CommodityType::Firearms, CommodityType::Medicine],
            PlanetType::ResearchOutpost => vec![CommodityType::Water, CommodityType::Foodstuffs],
            PlanetType::Industrial => vec![CommodityType::Water, CommodityType::Foodstuffs, CommodityType::Medicine],
    ...
    pub fn ignores(&self) -> Vec<CommodityType> {
        match self {
            PlanetType::Agricultural => vec![CommodityType::Metals, CommodityType::Antimatter, CommodityType::Narcotics, CommodityType::AlienArtefacts],
            PlanetType::MegaCity => vec![CommodityType::Metals, CommodityType::Antimatter, CommodityType::AlienArtefacts],
            PlanetType::Mining => vec![CommodityType::Narcotics, CommodityType::AlienArtefacts],
            PlanetType::PirateSpaceStation => vec![CommodityType::Water, CommodityType::Metals, CommodityType::Antimatter, CommodityType::Electronics, CommodityType::AlienArtefacts],
            PlanetType::ResearchOutpost => vec![CommodityType::Firearms, CommodityType::Ammunition, CommodityType::Metals, CommodityType::Antimatter, CommodityType::Narcotics],
...
mod tests {
    ...
    fn test_planet_type_properties() {
        assert_eq!(PlanetType::Agricultural.display_name(), "Agricultural Planet");
        assert_eq!(PlanetType::Agricultural.description(), "Agricultural Planet - Supplies Water, Foodstuffs; Demands Medicine, Firearms, Ammunition, Electronics");

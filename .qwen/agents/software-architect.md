...
2. If updating existing decision: create new ADR that supersedes previous one
3. Use sequential numbering: `0001-tech-decision.md`, `0002-another-decision.md`
